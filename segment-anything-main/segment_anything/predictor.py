...
class SamPredictor:
    ...
    def set_torch_image(
        ...
        # input_image = F.interpolate(input_image, size=(1024, 1024), mode='bilinear', align_corners=False)
    ...
    def predict_torch(
        ...
        image_pe_scaled = self.model.prompt_encoder.get_dense_pe()
        ...
        image_pe_orig = self.model.prompt_encoder.get_dense_pe()
